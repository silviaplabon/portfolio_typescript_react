...
export function BiographySkillsEducation() {
  ...
  return (
    <Box sx={{marginTop:'20px'}} id="biographySkillEducation">
    ...
    >
      <Box sx={{ width: matches ? "85%" : "65%", margin: "auto" }}>
        ...
        >
          <Grid container spacing={5} padding="10px" paddingTop="0px!important">
              ...
              Skills.map((skillType) => (
                <Box display="flex" marginTop="10px">
                  <Grid container spacing={7}>
                    ...
                    <Grid item xs={12} lg={7} sx={{paddingTop:matches?"0px!important":''}} >
                      <Box
                        display="flex"
                        alignItems="center"
                        flexWrap="wrap"
